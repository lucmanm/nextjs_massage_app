    ...
    <div className="max-w-6xl mx-auto space-y-4">
      ...
      <div className="grid gap-8 mt-12 md:grid-cols-2 lg:grid-cols-3">
        {testimonials.map((testimonial, index) => (
          ...
          >
            <Card className="relative z-10 h-full flex flex-col">
            ...
            <div className="absolute -right-2 -top-2 text-6xl text-slate-400 z-20">
              &quot;
            </div>
            <div className="absolute -left-2 -bottom-2 text-6xl text-slate-400 rotate-180 z-20">
              &quot;
            </div>
          </div>
        ))}
